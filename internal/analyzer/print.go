...
func Print(writer io.Writer, analysis *Analysis) {
	...
	printSection(writer, "Project structure", analysis.Structure)
	printSection(writer, "Architecture signals", analysis.Architecture)
	printSection(writer, "Conventions", analysis.Conventions)
