...
var english = map[string]string{
	...
	"embedding.short":            "Create and compare standalone embeddings",
	"embedding.create.short":     "Create an embedding for a short text",
	"embedding.similarity.short": "Calculate cosine similarity",
	"symbols.short":              "Extract structural code symbols",
	"output.created":             "Created %s\n",
	"output.exists":              "%s already exists; left it unchanged. Run `harnessforge validate --repository .` to check it.\n",
	"output.next_steps":          "Edit .harness/harness.yaml, then run `harnessforge validate --repository .` and `harnessforge generate codex --repository .`.\n",
...
var portuguese = map[string]string{
	...
	"embedding.short":            "Criar e comparar embeddings independentes",
	"embedding.create.short":     "Criar um embedding para um texto curto",
	"embedding.similarity.short": "Calcular similaridade de cosseno",
	"symbols.short":              "Extrair símbolos estruturais do código",
	"output.created":             "Criado %s\n",
	"output.exists":              "%s já existe; o arquivo não foi alterado. Execute `harnessforge validate --repository .` para verificá-lo.\n",
	"output.next_steps":          "Edite .harness/harness.yaml e execute `harnessforge validate --repository .` e `harnessforge generate codex --repository .`.\n",
